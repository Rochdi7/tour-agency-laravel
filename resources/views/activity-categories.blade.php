...
@section('meta_description')
    {{-- This meta description correctly uses the H1 and describes the page's purpose: browsing activity categories. It's
    concise and includes keywords. --}}
    <meta name="description"
        content="Explore exciting Morocco activities and excursions organized by category. Find cooking classes, desert adventures, city tours, cultural experiences, and more with Morocco Quest.">
@endsection
    ...
    <script type="application/ld+json">
        {
          ...
          "image": "{{ asset('assets/img/moroccan-belly-dance-night-cultural-activity.webp') }}",
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-content">
                                ...
                                <p class="breadcrumb-subtitle" style="color: white;">
                                    Experience the rhythm and magic of Moroccan cultural nights.
                                </p>
                                    ...
                                    <div class="activities-box">
                                        <figure class="activities-thumb">
                                            ...
                                            <a href="{{ route('activities.byCategory', ['category_slug' => $category->slug]) ?? '#' }}"
                                                aria-label="View activities in the {{ e($category->name) }} category"> {{-- Added
                                                e() for safety --}}
                                                ...
                                                <img src="{{ asset('storage/' . ($category->image_path ?? 'assets/img/activities/activity-placeholder.png')) }}"
                                                    ...
                                                    {{-- Fallback on error --}} {{-- width="400" height="300" --}} {{-- CRITICAL:
                                                    Add actual width/height to prevent layout shift --}} />
                                            </a>
                                        </figure>
