      ...
      <ul>
        ...
        <li class="menu-item-has-children">
          ...
          <ul class="sub-menu">
            ...
            <li><a href="{{ url('/terms-and-conditions') }}">Terms & Conditions</a></li> {{-- Use url helper --}}
...
<div class="popup-search-box">
  ...
  <form action="{{ route('search') }}" method="GET">
    <input type="text" class="border-theme" placeholder="What are you looking for" name="query" {{-- Use 'query'
      or 'search' as the input name --}} />
    <button type="submit">
      ...
      <div class="row justify-content-between align-items-center">
        <div class="col-xl-3 col-lg-auto">
          <div class="header-logo d-flex justify-content-between align-items-center">
            <a href="{{ url('/') }}"><img src="{{ asset('assets/img/logo-bg-white.webp') }}" alt="Morocco Quest"
                class="logo" /></a>
