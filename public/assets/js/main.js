        ...
        $(".destination-gallery, .sidebar-gallery").magnificPopup({
            ...
            image: {
                ...
                titleSrc: function (item) {
                    return (
                        item.el.attr("title") +
                        ` <a href="https://www.facebook.com/p/Colored-Morocco-100070928444096/profile.php?id=100069384085540" target="_blank" style="color: #f7921f;" rel="noopener noreferrer">&nbsp;Click Here</a>`
                    );
                },
            },
        });
