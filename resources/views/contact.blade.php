...
@section('meta_description')
    ...
    <meta name="description"
        content="Get in touch with Morocco Quest to plan your custom tour, ask questions, or book your Moroccan adventure. Contact our travel experts via phone, email, or contact form.">
@endsection
...
@section('structured_data')
    ...
    @php
        ...
        $twitterUrl = "https://x.com/mounirakajiamounirakajia"; // Replace placeholder
        $instagramUrl = "https://www.instagram.com/colored.morocco/"; // Replace placeholder
        $linkedinUrl = "https://www.instagram.com/colored.morocco/company/YourLinkedInPage"; // Replace placeholder
        $facebookUrl = "https://www.facebook.com/p/Colored-Morocco-100070928444096/p/Colored-Morocco-100070928444096/"; // Replace placeholder
        ...
        $schemaData = [
            ...
            'sameAs' => array_filter([
                ($twitterUrl !== 'https://x.com/mounirakajiamounirakajia' ? $twitterUrl : null),
                ($instagramUrl !== 'https://www.instagram.com/colored.morocco/' ? $instagramUrl : null),
                ($linkedinUrl !== 'https://www.instagram.com/colored.morocco/company/YourLinkedInPage' ? $linkedinUrl : null),
                ($facebookUrl !== 'https://www.facebook.com/p/Colored-Morocco-100070928444096/p/Colored-Morocco-100070928444096/' ? $facebookUrl : null),
            ]),
        ...
        if (empty($schemaData['telephone']))
            unset($schemaData['telephone']);
        if (empty($schemaData['contactPoint']))
            unset($schemaData['contactPoint']);
        if (empty($schemaData['sameAs']))
            unset($schemaData['sameAs']);
...
@section('content')
    ...
    <section class="vs-breadcrumb"
        ...
        <img src="{{ asset('assets/img/icons/cloud.png') }}" alt="Decorative cloud icon"
            ...
            height="Y" --}} {{-- Recommended: Add dimensions --}} />
                    ...
                    <div class="vs-contact-info mt-3 mb-2">
                        ...
                        <div class="social-follow">
                            ...
                            <ul class="custom-ul">
                                ...
                                <li>
                                    <a href="https://www.facebook.com/p/Colored-Morocco-100070928444096/p/Colored-Morocco-100070928444096/"
                                        target="_blank" rel="noopener noreferrer"
                                        aria-label="Follow Morocco Quest on Facebook">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                <input name="phone" type="tel" class="form-control @error('phone') is-invalid @enderror"
                                    placeholder="Phone Number*" value="{{ old('phone') }}" required autocomplete="tel"
                            ...
                            <div class="col-12 form-group">
                                <textarea name="travel_ideas"
                                    class="form-control @error('travel_ideas') is-invalid @enderror"
                                    placeholder="Tell us about your travel ideas (e.g., interests, places, pace, special occasions)"
                                    rows="4" aria-label="Your Travel Ideas">{{ old('travel_ideas') }}</textarea>
