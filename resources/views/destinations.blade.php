...
@section('meta_description')
    ...
    <meta name="description" content="Discover the best destinations in Morocco with Morocco Quest. Find guided tours, excursions, and activities in Marrakech, Fes, Chefchaouen, the Sahara Desert, and other top Moroccan locations.">
@endsection
...
@section('structured_data')
    ...
    <script type="application/ld+json">
    {
      ...
      "image": "{{ asset('assets/img/rabat-royal-palace-tourists-guided-walking-tour.jpg') }}",
...
@section('content')
    ...
    <section
        class="vs-breadcrumb"
        data-bg-src="{{ asset('assets/img/rabat-royal-palace-tourists-guided-walking-tour.jpg') }}" {{-- Ensure background is optimized --}}
    >
                ...
                <div class="col-12">
                    <div class="breadcrumb-content">
                        ...
                        <figcaption class="image-caption" style="color: white; font-size: medium;">
                            A group of tourists approaching the Royal Palace in Rabat during a guided walking tour on a clear day.
                        </figcaption>

                        <p class="visually-hidden">
                            A guided group tour exploring the surroundings of the Royal Palace in Rabat, Morocco. This iconic landmark is a must-see attraction, known for its elegant architecture, historical significance, and serene atmosphere.
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                class="destination-box-2 d-block text-decoration-none"
                                    ...
                                    <figure class="destination-thumb">
                                        ...
                                        <img src="{{ $imageUrl }}"
                                             alt="Explore tours in {{ e($place->name) }}, Morocco" {{-- Added e() for safety --}}
                                             class="w-100" {{-- Ensure responsiveness --}}
                                             loading="lazy" {{-- Added Lazy Loading --}}
                                             onerror="this.onerror=null;this.src='{{ asset('assets/img/destination/destination-1-1.png') }}';" {{-- Fallback on error --}}
                                             {{-- width="300" height="400" --}} {{-- CRITICAL: Add actual width/height to prevent layout shift --}}
                                             />
                                    </figure>
                                    <div class="destination-content">
                                        ...
                                        {{-- Tour Count Info --}}
                                        <span class="info">
                                            {{ $place->tours_count ?? 0 }} {{ Str::plural('Tour', $place->tours_count ?? 0) }} Available
                                        </span>
                                    </div>
                                </a>
                            </div>
