...
<div class="vs-menu-wrapper">
  <div class="vs-menu-area text-center">
    <div class="mobile-logo">
      ...
      <a href="{{ url('/') }}">
          <img src="{{ asset('assets/img/logo.svg') }}" alt="Morocco Quest" class="logo"/> {{-- Kept header2 logo, updated alt text --}}
      </a>
...
<div class="popup-search-box">
  ...
  <form action="{{ route('search') }}" method="GET">
    <input
      type="text"
      name="query" {{-- Use name="query" --}}
      class="border-theme"
      placeholder="What are you looking for"
      required {{-- Kept required from header2 --}}
    />
      ...
      <div class="row justify-content-between align-items-center">
        ...
        <div class="col-xl-auto col-lg-auto col-sm-3 d-none d-sm-block">
          ...
          <div class="logo d-lg-none">
            ...
            <a href="{{ url('/') }}">
                <img src="{{ asset('assets/img/logo.svg') }}" alt="Morocco Quest" class="logo"/>
            </a>
          </div>
        </div>
          ...
          <div class="header-wc style2"> {{-- Kept classes from header2 --}}
            <button class="wc-link2 searchBoxTggler text-title-color">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none" aria-hidden="true">
                  <path d="M20.4174 16.6954L17.2213 13.4773C19.3155 10.0703 18.8936 5.54217 15.9593 2.58766C12.5328 -0.862552 6.9769 -0.862552 3.55037 2.58766C0.123835 6.03787 0.123835 11.6322 3.55037 15.0824C6.5354 18.088 11.1341 18.4736 14.5333 16.2469L17.7019 19.4335C18.4521 20.1888 19.6711 20.1888 20.4213 19.4335C21.1675 18.6781 21.1675 17.4507 20.4174 16.6954ZM5.711 12.9029C3.48395 10.6604 3.48395 7.00959 5.711 4.76715C7.93805 2.52471 11.5638 2.52471 13.7909 4.76715C16.018 7.00959 16.018 10.6604 13.7909 12.9029C11.5638 15.1453 7.93805 15.1453 5.711 12.9029Z" fill="#F6F5F5"></path> {{-- Note: Fill color might need adjustment based on theme CSS --}}
              </svg>
            </button>
            {{-- Kept SVG Divider from header2 --}}
            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="39" viewBox="0 0 6 39" fill="none" aria-hidden="true">
            ...
            <div class="logo d-none d-sm-block">
              {{-- Use 'let's plan' link from header1, keep button style from header2 (style10 then style8 was used, stick with style8 like header1) --}}
                  ...
                  <div class="contact-info">
                    ...
                    <ul class="custom-ul">
                      ...
                      <li>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="4" height="22" viewBox="0 0 4 22" fill="none" aria-hidden="true"> <line x1="0.75" y1="2.774e-08" x2="0.749999" y2="21.6114" stroke="white" stroke-opacity="0.3" stroke-width="1.5"/> <line x1="3.5" y1="3.92926" x2="3.5" y2="17.682" stroke="white" stroke-opacity="0.3"/> </svg>
                      </li>
                      <li>
                ...
                <div class="col-md-6">
                  <div class="social-share">
                    <span class="info-share">Follow on:</span>
                     {{-- SVG Divider (kept from header2, identical to header1's) --}}
                    <svg xmlns="http://www.w3.org/2000/svg" width="4" height="22" viewBox="0 0 4 22" fill="none" aria-hidden="true"> <line x1="0.75" y1="2.774e-08" x2="0.749999" y2="21.6114" stroke="white" stroke-opacity="0.3" stroke-width="1.5"/> <line x1="3.5" y1="3.92941" x2="3.5" y2="17.6821" stroke="white" stroke-opacity="0.3"/> </svg>
        ...
        <div class="row justify-content-between align-items-center">
          <div class="col-xl-3 col-lg-auto">
            <div class="header-logo d-flex justify-content-between align-items-center">
              {{-- Use url() for home link, keep header2 logo, update alt --}}
              <a href="{{ url('/') }}">
                  <img src="{{ asset('assets/img/logo-bg.png') }}" alt="Morocco Quest" class="logo"/> {{-- Kept header2 V2 logo, updated alt text --}}
              </a>
              <div class="d-flex align-items-center gap-3">
                <button class="wc-link2 searchBoxTggler d-lg-none">
                    {{-- Kept header2 Mobile Search Icon --}}
                   <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none" aria-hidden="true">
                      <path d="M20.4174 16.6954L17.2213 13.4773C19.3155 10.0703 18.8936 5.54217 15.9593 2.58766C12.5328 -0.862552 6.9769 -0.862552 3.55037 2.58766C0.123835 6.03787 0.123835 11.6322 3.55037 15.0824C6.5354 18.088 11.1341 18.4736 14.5333 16.2469L17.7019 19.4335C18.4521 20.1888 19.6711 20.1888 20.4213 19.4335C21.1675 18.6781 21.1675 17.4507 20.4174 16.6954ZM5.711 12.9029C3.48395 10.6604 3.48395 7.00959 5.711 4.76715C7.93805 2.52471 11.5638 2.52471 13.7909 4.76715C16.018 7.00959 16.018 10.6604 13.7909 12.9029C11.5638 15.1453 7.93805 15.1453 5.711 12.9029Z" fill="#141414"></path> {{-- Note: Fill color might need adjustment based on theme CSS --}}
                   </svg>
                </button>
          ...
          <div class="col-xl-9 col-lg-auto d-none d-lg-flex justify-content-end gap-md-4 gap-xl-5">
            ...
            <div class="header-wc style2"> {{-- Kept style2 class --}}
              <button class="wc-link2 searchBoxTggler">
                 ...
                 <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none" class="text-title-color" aria-hidden="true"> {{-- Kept text-title-color class --}}
                    <path d="M20.4174 16.6954L17.2213 13.4773C19.3155 10.0703 18.8936 5.54217 15.9593 2.58766C12.5328 -0.862552 6.9769 -0.862552 3.55037 2.58766C0.123835 6.03787 0.123835 11.6322 3.55037 15.0824C6.5354 18.088 11.1341 18.4736 14.5333 16.2469L17.7019 19.4335C18.4521 20.1888 19.6711 20.1888 20.4213 19.4335C21.1675 18.6781 21.1675 17.4507 20.4174 16.6954ZM5.711 12.9029C3.48395 10.6604 3.48395 7.00959 5.711 4.76715C7.93805 2.52471 11.5638 2.52471 13.7909 4.76715C16.018 7.00959 16.018 10.6604 13.7909 12.9029C11.5638 15.1453 7.93805 15.1453 5.711 12.9029Z" fill="currentColor"/>
                 </svg>
              </button>
